...
-- we could also use extract to extract month from order date and delivery date
...
--- first we check if the customers are duplicated using the distinct function
--- we use customer email because customer email is unique for each customer

SELECT DISTINCT customer_email
FROM fashion.fashion;

--- then now we identify the top customers
